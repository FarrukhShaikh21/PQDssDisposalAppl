package pqt.dss.disposal.model.am;
...
import pqt.dss.disposal.model.am.common.DisposalAM;
import java.sql.Types;

import pqt.dss.disposal.model.vo.DssDisposalNoteHeaderViewImpl;


// ---------------------------------------------------------------------
// ---    File generated by Oracle ADF Business Components Design Time.
// ---    Fri Oct 07 10:58:20 PKT 2016
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class DisposalAMImpl extends ApplicationModuleImpl implements DisposalAM {
    /**
     * This is the default constructor (do not remove).
     */
    public DisposalAMImpl() {
    }
    ...
    public String Apply()
    {
        if (getDBTransaction().isDirty()){
            ...
            FacesMessage Message = new FacesMessage("Record have been saved successfully!");
    ...
    public void callWorkflow(Number p_document_id, String ApprovalType) {
        ...
        String p_notification_message = "Approval Required for Disposal Note.", p_status = null;
        ...
        if (WfVO.getRowCount() == 0) {
            ...
            ViewObject vo = this.getDssDisposalNoteHeaderView1();
            if (vo.getRowCount() == 0) {
            ...
            try {
                ...
                if (vNotifId != null) {
                    if ("BRANCH".equalsIgnoreCase(ApprovalType)) {
                        this.getDssDisposalNoteHeaderView1().getCurrentRow().setAttribute("BranchStatus", "INPROCESS");
                        this.getDssDisposalNoteHeaderView1().getCurrentRow().setAttribute("BranchNotifIdFk", vNotifId);
                    } else if ("DSS".equalsIgnoreCase(ApprovalType)) {
                        this.getDssDisposalNoteHeaderView1().getCurrentRow().setAttribute("DssStatus", "INPROCESS");
                        this.getDssDisposalNoteHeaderView1().getCurrentRow().setAttribute("DssNotifIdFk", vNotifId);
                    }
                    getDBTransaction().commit();
                }
        ...
        this.getDssDisposalNoteHeaderView1().executeQuery();
    }
    ...
    /**
     * Container's getter for DssDisposalNoteHeaderView1.
     * @return DssDisposalNoteHeaderView1
     */
    public DssDisposalNoteHeaderViewImpl getDssDisposalNoteHeaderView1() {
        return (DssDisposalNoteHeaderViewImpl) findViewObject("DssDisposalNoteHeaderView1");
    }

    /**
     * Container's getter for DssDisposalNoteView1.
     * @return DssDisposalNoteView1
     */
    public ViewObjectImpl getDssDisposalNoteView1() {
        return (ViewObjectImpl) findViewObject("DssDisposalNoteView1");
    }

    /**
     * Container's getter for DssDisposalNoteHdrFkLink1.
     * @return DssDisposalNoteHdrFkLink1
     */
    public ViewLinkImpl getDssDisposalNoteHdrFkLink1() {
        return (ViewLinkImpl) findViewLink("DssDisposalNoteHdrFkLink1");
    }
    public void callDisposalWorkflow(Number p_document_id) {
           ...
           callableStatement =
               (OracleCallableStatement) txn.createCallableStatement("BEGIN dss_all_pkg.CALL_DISPOSAL_WORKFLOW(:1, :2, :3); END;",
                                                                     DBTransaction.DEFAULT);
